...
const STOP = new Set([
  // كلمات حشو زمنية/حالية — "انا **حاليا** واقف في الشمس" كانت بتطابق
  // تعليمة فيها "التي تعمل عليها حاليا" وترد برد عن البالتات الخشب!
  // (22 سبتمبر 2026)
  'حاليا', 'دلوقتي', 'دلوقت', 'النهارده', 'انهارده', 'الوقتي', 'الان', 'عادي', 'اوي', 'خالص',
  'واقف', 'واقفه', 'قاعد', 'ماشي', 'شغال', 'بشتغل', 'بقالي',
