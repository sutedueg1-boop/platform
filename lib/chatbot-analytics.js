...
// helpers: نفس تعريفات "مفتوح/مغلق/محذوف/ساعات التدريب" اللي الشات بوت
// واللوحة بيستخدموها — تابة التقارير (lib/reports.js) بتاخدها من هنا عشان
// الأرقام تطلع متطابقة في كل حتة. (22 سبتمبر 2026)
const helpers = {
  normCode, normName, dateOf, isDeletedRec, trainingHours, attCode, arr, inScope,
  HAZ_OPEN, HAZ_DONE, HAZ_REJECTED, riskOf, RISK_LABEL, HOURS_48,
  PERMIT_PENDING, PERMIT_STATUS_LABEL, PERMIT_TYPE_LABEL,
  TRAIN_TARGET, HAZARD_TARGET, PENALTY_DEDUCTION,
};

module.exports = { answerAnalytics, isAdminDataQuestion, complianceData, ADMIN_ROLES, helpers };
